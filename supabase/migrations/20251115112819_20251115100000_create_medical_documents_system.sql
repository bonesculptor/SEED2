...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE tablename = 'medical_document_categories' 
    AND policyname = 'Authenticated users can view categories'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'patient_medical_documents' 
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'patient_medical_documents' 
    AND policyname = 'Patients can upload documents'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'patient_medical_documents' 
    AND policyname = 'Patients can update own documents'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    AND policyname = 'Patients can view own extractions'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'document_extractions' 
    AND policyname = 'Patients can insert extractions'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'document_extractions' 
    AND policyname = 'Patients can update extractions'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'document_sharing_permissions' 
    AND policyname = 'Patients can manage document sharing'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    AND policyname = 'Patients can view access logs'
  ) THEN
